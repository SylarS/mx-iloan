...
import com.panshi.hujin2.iloan.view.activity.SplashActivity;
...
public class PushIntentService extends GTIntentService {
    ...
    public void onNotificationMessageClicked(Context context, GTNotificationMessage message) {
        ...
        Log.d(TAG, "onNotificationMessageClicked -> " + "appid = " + message.getAppid() + "\ntaskid = " + message.getTaskId() + "\nmessageid = "
                + message.getMessageId() + "\npkg = " + message.getPkgName() + "\ncid = " + message.getClientId() + "\ntitle = "
                + message.getTitle() + "\ncontent = " + message.getContent());
        if (AppStaus.userInfo != null && !TextUtils.isEmpty(AppStaus.userInfo.getToken())) {
            ...
            if (AppStaus.mContext != null) {
                Intent intent = new Intent(AppStaus.mContext, SplashActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
