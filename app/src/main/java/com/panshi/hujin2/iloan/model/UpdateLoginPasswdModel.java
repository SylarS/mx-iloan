...
public abstract class UpdateLoginPasswdModel implements BaseModel {
    public void updateLoginPasswd(String oldPw, String newPw, final UpdateLoginPasswd updateLoginPasswd) {
        ...
        RetrofitFactory.createFactoty().create(UserApi.class).
                updateLoginPasswd(MediaTypeUtil.createJsonMediaType(GonsonUtil.buildGosn().toJson(updatePassReq))).
            ...
            public void onNext(@NonNull Response response) {
                ...
                updateLoginPasswd.updateSucess();
            }
        });
    }
    public  interface UpdateLoginPasswd{
        void updateSucess();
    }
